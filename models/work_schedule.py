...
class Work_Schedule(Base):
    """Datamodel for Work_Schedule
    модель таблицы справочника графиков работы (гибкий, сменный,
    30 часов в неделю, вахтовый... и т.п.)
    """
    internal_id = Column(
    ...
    # UniqueConstraint(
    #     ['public_id'], name='idxu_Work_Schedule_public_id', deferrable=True
    # )
    # ForeignKeyConstraint(
    #     'last_app_user_id', ['Application_User.internal_id'],
    #     use_alter=True, name='work_schedule_application_user_internal_id_fk',
    #     deferrable=True
    # )
    #
